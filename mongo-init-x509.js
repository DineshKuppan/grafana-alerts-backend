...
db.runCommand({
  createUser: "CN=monitoring_client,O=MonitoringApp,L=San Francisco,ST=CA,C=US",
  roles: [
    {
      role: 'readWrite',
...
// Switch to monitoring-alerts database
...
print('MongoDB initialized successfully for monitoring alerts with X.509 authentication');
print('Created collections: alerts, alert_summaries');
print('Created X.509 user: CN=monitoring_client,O=MonitoringApp,L=San Francisco,ST=CA,C=US');
